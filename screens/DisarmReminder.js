...
export default class DisarmReminderScreen extends React.Component {
        ...
        <View style={styles.container}>
          <ScrollView style={styles.getStartedContainer} contentContainerStyle={styles.contentContainer}>
            ...
            <View style={styles.getStartedContainer}>
              ...
              <Text style={styles.getStartedText}>You have reached your destination! Remember to take your passengers with you.</Text>
